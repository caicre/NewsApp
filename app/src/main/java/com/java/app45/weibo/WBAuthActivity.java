...
public class WBAuthActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mAccessToken.isSessionValid()) {
            Toast.makeText(WBAuthActivity.this,"已授权过(SelfWbAuthListener)", Toast.LENGTH_SHORT).show();
    ...
    private class SelfWbAuthListener implements com.sina.weibo.sdk.auth.WbAuthListener{
            ...
            WBAuthActivity.this.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (mAccessToken.isSessionValid()) {
                        ...
                        Toast.makeText(WBAuthActivity.this,"授权成功(SelfWbAuthListener)", Toast.LENGTH_SHORT).show();
                        WBAuthActivity.this.finish();
                    }
                }
            });
        ...
        @Override
        public void cancel() {
            Toast.makeText(WBAuthActivity.this,"weibosdk_demo_toast_auth_canceled", Toast.LENGTH_LONG).show();
        }
