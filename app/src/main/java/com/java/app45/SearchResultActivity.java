...
public class SearchResultActivity extends AppCompatActivity implements NewsActivity{
    ...
    SearchResultActivity.ListViewAdapter2 adapt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapt = new SearchResultActivity.ListViewAdapter2(newsList);
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {            //设置点击事件
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                mPosition = position;
                adapt.notifyDataSetChanged();
                Toast.makeText(SearchResultActivity.this,"进入详情"+position,Toast.LENGTH_LONG).show();
    ...
    public class ListViewAdapter2 extends BaseAdapter {
        ...
        public void setActivity(SearchResultActivity activity) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            SearchResultActivity.ViewHolder holder = null;
            LayoutInflater inflater = (LayoutInflater) SearchResultActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.item_news, null);
                holder = new SearchResultActivity.ViewHolder();
            ...
            holder = (SearchResultActivity.ViewHolder) convertView.getTag();
